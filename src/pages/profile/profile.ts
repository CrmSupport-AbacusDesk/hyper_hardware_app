...
export class ProfilePage {
    ...
    share_code()
    {
        ...
        this.socialSharing.share("Hey! Join me  (" + this.karigar_detail.full_name + " " + this.karigar_detail.country_code + " "  + this.karigar_detail.mobile_no + ") on Fluid Hardware- Carpenter Rewards Application. Enter the code-*" + this.karigar_detail.referral_code + "* to earn"+ " " +this.karigar_detail.refer_own_point+ " " + "Points in your wallet","Karigar Reffral", image, app_url)
        .then(resp => {
            console.log(resp);
