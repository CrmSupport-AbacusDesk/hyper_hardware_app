...
export class HomePage {
    ...
    //   }
        ...
        share()
        {
            ...
            this.socialSharing.share("Hey! Join me (" + this.karigar_detail.full_name + " " + this.karigar_detail.mobile_no + " "  +  this.karigar_detail.country_code + ") on Fluid Hardware- Carpenter Rewards Application. Enter the code-" + this.karigar_detail.referral_code + "* to earn Extra points in your wallet.", image, app_url)
            .then(resp=>{
                console.log(resp);
